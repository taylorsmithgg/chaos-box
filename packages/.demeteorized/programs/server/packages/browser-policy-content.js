...
// allow<content type>DataUrl(): allows the content to be loaded from data: URLs // 23
...
_.extend(BrowserPolicy.content, {                                                // 143
  ...
  setPolicy: function (csp) {                                                    // 172
    ...
    setWebAppInlineScripts(                                                      // 175
      BrowserPolicy.content._keywordAllowed("script-src", keywords.unsafeInline) // 176
    );                                                                           // 177
  },                                                                             // 178
                                                                                 // 179
